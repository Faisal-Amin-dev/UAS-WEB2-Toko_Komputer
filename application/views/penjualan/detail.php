    ...
    <div class="flex-grow-1 p-4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <table class="table table-sm table-borderless">
                            <tr><td><strong>Nota</strong></td><td>: <?= $penjualan->nota_transaksi; ?></td></tr>
                            <tr><td><strong>Tanggal</strong></td><td>: <?= date('d/m/Y H:i', strtotime($penjualan->tanggal_transaksi)); ?></td></tr>
                        </table>
                    </div>
                    <div class="col-md-6">
                        <table class="table table-sm table-borderless">
                            <tr><td><strong>Kasir</strong></td><td>: <?= $penjualan->nama_lengkap; ?></td></tr>
                            <tr><td><strong>Total Bayar</strong></td><td>: <strong>Rp <?= number_format($penjualan->total_bayar, 0, ',', '.'); ?></strong></td></tr>
                        </table>
                    </div>
                </div>
            </div>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-footer text-right">
                ...
                <?php if ($user['role'] === 'admin') : ?>
                <a href="<?= base_url('penjualan/delete/' . $penjualan->id_penjualan); ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin membatalkan transaksi ini? Stok akan dikembalikan.')"><i class="fas fa-trash mr-1"></i>Batalkan Transaksi</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
